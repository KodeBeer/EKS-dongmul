...
class AlphaSource(tk.Tk):
    ...
    def initTheGui(self):
        ...
        excitementSlider = ttk.Scale(self,from_= 1.0 ,to = 0.1, orient='vertical', command=self. excitementSlider_changed, 
        ...
        curiositySlider = ttk.Scale(self,from_= 1.0 ,to = 0.1, orient='vertical', command=self.curiositySlider_changed, 
        ...
        self.message_label.grid(column=2,row=1,sticky='we')
